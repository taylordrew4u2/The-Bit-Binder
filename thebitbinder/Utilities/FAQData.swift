...
enum FAQData {
    static let sections: [FAQSectionModel] = [
        ...
        FAQSectionModel(title: "Notepad", icon: "note.text", items: [
            FAQItem("What is the Notepad?",
                    "The Notepad is a single, always-there lined page for freeform notes — premises, tags, to-dos, whatever. It's one continuous scrollable page, not a list of separate notes."),
            FAQItem("Does the Notepad sync across devices?",
                    "Yes — your Notepad follows you to every device signed into the same iCloud account."),
            FAQItem("What happened to the Photo Notebook?",
                    "The Notebook tab is now the text Notepad. Your old photo notebook is safe — find it under Settings → Photo Notebook (Legacy), where you can view your photos and export them."),
            FAQItem("How do I get my old notebook photos out?",
                    "Open Settings → Photo Notebook (Legacy), tap the share button, and export everything as a single PDF or as a .zip of the original images. Then text, AirDrop, or save the file anywhere."),
        ]),
        ...
        FAQSectionModel(title: "Recordings", icon: "waveform.circle.fill", items: [
            ...
            FAQItem("Do my recordings play on my other devices?",
                    "Yes — with iCloud Sync on, the recording's audio (not just its title) syncs, so you can play a set you recorded on another device."),
        ...
        FAQSectionModel(title: "iCloud Sync", icon: "icloud.and.arrow.up.fill", items: [
            ...
            FAQItem("What gets synced to iCloud?",
                    "Everything — jokes, roasts, set lists, recordings (including the audio), your Notepad, brainstorm ideas, and legacy notebook photos. Your name and app settings sync too, so a new device feels like home."),
